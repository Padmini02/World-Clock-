...
function App() {
  ...
  const [name2, setName2] = useState('Africa/Algiers')
  const [name3, setName3] = useState('Africa/Algiers')
  const [name4, setName4] = useState('Africa/Algiers')
  return (
    <main>
      <div className="container">
        ...
        <div className="clock--wrapper">
          ...
          <div className="clock" data-locale={name2}>
          </div>
        </div>
        <div className="clock--wrapper">
          <h2>{name3}</h2>
          ...
          <div className="clock" data-locale={name3}>
          </div>
        </div>
        <div className="clock--wrapper">
          <h2>{name4}</h2>
          ...
          <div className="clock" data-locale={name4}>
          </div>
        </div>
